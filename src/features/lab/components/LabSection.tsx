  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-screen-2xl gap-20 px-6 md:grid-cols-2 md:px-12">
        <Reveal>
          <SectionHeading indexLabel="[ 02 ]" title="Ingenieria" className="mb-8" />

          <p className="text-2xl font-light leading-snug text-zinc-300 md:text-3xl">
            Mi enfoque combina rigor tecnico con sensibilidad estetica. Creo interfaces que no solo
            funcionan rapido, sino que se sienten{' '}
            <span className="italic text-white">inevitables</span>.
          </p>
        </Reveal>
